<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("AnnoNascita");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid AnnoNascita");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: DemoBP.CalcolaTs
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">AnnoNascita</label>
                            		<div class="div_texbox">
                              		<input name="AnnoNascita" type="text" class="textbox" id="AnnoNascita" value="${AnnoNascita}" />
                            		</div>
